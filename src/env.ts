...
let envVariables = {
  ...
  AUTHORIZATION_SERVER: process.env.REACT_APP_AUTHORIZATION_SERVER || 'https://login.ivao.aero/index.php?url={url}',
...
if (activeEnv === 'development') {
  envVariables = {
      ...
      LOGO_URL: process.env.REACT_APP_LOGO_URL || 'https://assets.br.ivao.aero/logos/tag_white.png',
      MAIN_SYSTEM_URL: process.env.REACT_APP_MAIN_SYSTEM_URL || 'https://kronos.br.ivao.aero',
      AUTHORIZATION_SERVER: process.env.REACT_APP_AUTHORIZATION_SERVER || 'http://localhost:3003/login?url={url}',
